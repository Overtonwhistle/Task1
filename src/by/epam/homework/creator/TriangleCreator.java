...
public class TriangleCreator {
	 ...
	 * @throws TriangleException
	 */
	public List<Triangle> getTrianglesList(List<double[]> listOf—oordinatesArrays) {

		List<Triangle> TrianglesList = new ArrayList<>();

		for (int i = 0; i < listOf—oordinatesArrays.size(); i++) {

			double[] coordinates = listOf—oordinatesArrays.get(i);
